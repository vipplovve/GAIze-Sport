...
def extract_lstm_data_from_videos(source_dir, output_dir, sport="football", seq_len=30, log_callback=None, stop_event=None):
    ...
    sport = sport.lower()
    data_path = output_dir / f"lstm_train_data_{sport}.npy"
    labels_path = output_dir / f"lstm_train_labels_{sport}.npy"
...
if __name__ == "__main__":
    ...
    extract_lstm_data_from_videos(args.source, args.output, args.sport, args.seq_len)
